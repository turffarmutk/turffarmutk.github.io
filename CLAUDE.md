...
|---|---|---|
| `app-01-shell.js` | 2,300 | Per-person preferences, the phone/roomy shell, the notification feed (`ntfScan()` and the Notifications screen), home-screen widgets, theme and color-blind mode |
