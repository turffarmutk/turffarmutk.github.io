...
ok('the store module is present', Array.isArray(first.p.STORE_DEFS) && first.p.STORE_DEFS.length === 10,
...
{
  const want = ["tasks","inventory","equip","eqmaint","eqproblems","eqcheckout","eqsched","events","bugs","invmoves"];
